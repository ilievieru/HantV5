...
var currentMotionDetectedValue;
var port = process.argv[2] === undefined ? 8084 : process.argv[2];
var serviceId = 5+port;
...
app.get('/GenerateStart', function (req, res) {
    ...
    started = true;
    continuousPublishing = setTimeout(publish, tools.getRandomInterval(1900, 5000), generateRawData());
})
...
function generateRawData(){
    currentMotionDetectedValue = tools.rand(15);
